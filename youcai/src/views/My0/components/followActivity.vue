...
// import ActivityItem from '@/components/newProfile/activityItemOne'
  ...
  methods: {
    ...
    getFollowActivity () {
      ...
      if (this.routerType === 1) {
        activityUrl = `Operate?PageIndex=${me.curPage}&PageSize=${me.pageSize}`
      } else {
        activityUrl = `Operate?UserId=${UserId}&PageIndex=${me.curPage}&PageSize=${me.pageSize}`
      }
      me.api.get({
        url: activityUrl,
