<template>
  <div class="weui-cell" ref="weuiWrapper">
        ...
        <div class="weui-uploader__bd">
          ...
          <div class="weui-uploader__input-box" v-show="!isUploadVideo">
            <a href="javascript:;" :id="uploaderId">
              <input class="weui-uploader__input" type="file" multiple="multiple">
            </a>
          </div>
  ...
  mounted () {
    ...
    weui.uploader('#' + me.uploaderId, {
      ...
      onBeforeQueued: function (files) {
        console.log('files', files, this.type)
        // if (['video/mp4'].indexOf(this.type) >= 0) {
        //   let vio = document.createElement('video')
        //   let source = document.createElement('source')
        //   source.src = files
        //   source.type = "video/mp4"
        //   vio.appendChild(source)
        //   console.log(vio, 23232)
        //   vio.style = {
        //     position: 'fixed',
        //     top: 0,
        //     left:0
        //   }
        //   document.querySelector('#appContent').appendChild(vio)
        // }
