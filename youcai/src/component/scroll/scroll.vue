<template>
  <div ref="wrapper" class="list-wrapper">
    <div class="scroll-content">
      <div ref="listWrapper" style="overfollow: hidden;">
        <slot>
    ...
    >
      <div ref="pulldown" class="pulldown-wrapper" :style="pullDownStyle" v-if="pullDownRefresh">
        ...
        <div class="after-trigger" v-else>
          ...
          <div v-else><span class="refreshText">{{refreshTxt}}</span></div>
        </div>
      </div>
    </slot>
  </div>
...
export default {
  ...
  methods: {
    initScroll () {
      ...
      this.scroll = new window.BScroll(this.$refs.wrapper, options)
    ...
    autoPullDownRefresh () {
      this.scroll && this.scroll.autoPullDownRefresh().apply(this.scroll)
    },
    scrollToElement () {
